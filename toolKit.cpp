...
class Constraint
{
	...
	{
		std::vector param= rule->parameterList();
...
class AllConstraints
{
	...
	{
		for (std::list<int>::iterator it=rules.begin(); it != rules.end(); ++it)
		{
